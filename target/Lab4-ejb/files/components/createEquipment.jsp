...
<div class="container create-item">
    <div class="row">
        <div class="col-xs-8 col-sm-4 creation-pane">
            ...
            <form class="creation-form" id="form-equipment-creation">
                ...
                <div class="form-group">
                    <input type="number" name="parry" class="form-control statistics"
                           placeholder="К уклонению"
                           onfocus="addScores(this.value)"
                           onblur="minusScores(this.value)">
                </div>
                <div class="form-group">
                    <input type="number" name="speed" class="form-control statistics"
                           placeholder="К скорости"
                           onfocus="addScores(this.value)"
                           onblur="minusScores(this.value)">
                </div>
                <hr>
                <button type="button" class="btn btn-primary btn-block" onclick="createEquipment()">Создать</button>
            </form>
